    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        buttonP4.setOnClickListener {
            if(radioGroupP4.checkedRadioButtonId ==-1){
                ...
                when(radioGroupP4){
                    radioButtonP4A -> pergunta1ViewModel.soma0()
                    radioButtonP4B -> pergunta1ViewModel.soma2()
                    radioButtonP4C -> pergunta1ViewModel.soma4()
                }
                findNavController().navigate(R.id.pergunta5)
            }
        }
    }
}